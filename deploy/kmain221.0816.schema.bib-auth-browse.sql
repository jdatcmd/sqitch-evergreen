...
-- Section 1: authority.control_set_authority_field table -- SAFE
...
-- Section 2: metabib.browse_entry_def_map and config.metabib_field  -- SAFE
-- I think this breaks it because in KCLS, they changed some of the formats to kcls and changed the xpath.
...
-- Section 3: metabib.reingest_metabib_field_entries function
...
-- Section 4: biblio.extract_metabib_field_entry function
...
-- Section 6: config.xml_transform 
...
-- Section 7: config.xml_transform
...
-- Section 10: metabib.browse_entry and metabib.browse_entry_def_map
...
-- Section 11: metabib.flat_browse_entry_appearance
...
-- Section 12: metabib.browse_pivot function
...
-- Section 13: metabib.browse function
...
SET
    ...
    browse_xpath = NULL
WHERE
    field_class = 'series' AND name = 'seriestitle' AND format = 'mods32';
...
SET
    ...
    browse_field = TRUE
WHERE
    field_class = 'title' AND name = 'proper' AND format = 'mods32';
...
SET
    ...
    browse_xpath = NULL
WHERE
    field_class = 'title' AND name = 'alternative' AND format = 'mods32';
...
SET
    ...
    browse_xpath = NULL
WHERE
    field_class = 'title' AND name = 'uniform' AND format = 'mods32';
...
SET
    ...
    browse_xpath = NULL
WHERE
    field_class = 'title' AND name = 'translated' AND format = 'mods32';
...
-- Section 14: config.org_unit_setting_type
